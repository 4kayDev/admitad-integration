...
const (
	...
	AdmitadIntegration_ToggleSaveOffer_FullMethodName  = "/admitadintegration.AdmitadIntegration/ToggleSaveOffer"
...
type AdmitadIntegrationClient interface {
	...
	ToggleSaveOffer(ctx context.Context, in *ToggleSaveOfferRequest, opts ...grpc.CallOption) (*ToggleSaveOfferResponse, error)
...
func (c *admitadIntegrationClient) ToggleSaveOffer(ctx context.Context, in *ToggleSaveOfferRequest, opts ...grpc.CallOption) (*ToggleSaveOfferResponse, error) {
	out := new(ToggleSaveOfferResponse)
	err := c.cc.Invoke(ctx, AdmitadIntegration_ToggleSaveOffer_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AdmitadIntegrationServer interface {
	...
	ToggleSaveOffer(context.Context, *ToggleSaveOfferRequest) (*ToggleSaveOfferResponse, error)
...
func (UnimplementedAdmitadIntegrationServer) ToggleSaveOffer(context.Context, *ToggleSaveOfferRequest) (*ToggleSaveOfferResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ToggleSaveOffer not implemented")
}
...
func _AdmitadIntegration_ToggleSaveOffer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ToggleSaveOfferRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AdmitadIntegrationServer).ToggleSaveOffer(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AdmitadIntegration_ToggleSaveOffer_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdmitadIntegrationServer).ToggleSaveOffer(ctx, req.(*ToggleSaveOfferRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AdmitadIntegration_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ToggleSaveOffer",
			Handler:    _AdmitadIntegration_ToggleSaveOffer_Handler,
		},
		{
