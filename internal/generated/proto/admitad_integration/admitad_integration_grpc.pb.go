...
func (c *admitadIntegrationClient) GetSavedOffersByHidden(ctx context.Context, in *GetSavedOffersByHiddenRequest, opts ...grpc.CallOption) (*GetSavedOffersByHiddenResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/admitadintegration.AdmitadIntegration/GetSavedOffersByHidden", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *admitadIntegrationClient) GetOfferByNameOrDescription(ctx context.Context, in *GetOfferByNameOrDescriptionRequest, opts ...grpc.CallOption) (*GetOfferByNameOrDescriptionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/admitadintegration.AdmitadIntegration/GetOfferByNameOrDescription", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AdmitadIntegration_GetSavedOffersByHidden_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/admitadintegration.AdmitadIntegration/GetSavedOffersByHidden",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AdmitadIntegration_GetOfferByNameOrDescription_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/admitadintegration.AdmitadIntegration/GetOfferByNameOrDescription",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
